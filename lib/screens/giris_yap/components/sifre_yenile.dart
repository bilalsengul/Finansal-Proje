              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(height: yuksekligeGoreAyarla(context, 4),),
                    ...
                    Padding(
                      ...
                      child: Button(
                        onPressed:()async {
                          ...
                          _showMyDialog(context, "E-mail adresinize parola sıfırlama bağlantısı içeren bir e posta gönderildi.");
...
AppBar _appBar(BuildContext context) {
  return AppBar(
    centerTitle: true,
    title: Text("Şifre Yenile", style: TextStyle(
        color: kPrimaryColor,
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          ...
          child: ListBody(
            children: <Widget>[
              Image.network("https://cdn.icon-icons.com/icons2/1506/PNG/512/emblemok_103757.png",height: yuksekligeGoreAyarla(context, 96),),
